...
gs.setup({
  ...
  on_attach = function()
    ...
    keymap('v', '<leader>hs', function() gs.stage_hunk({ vim.fn.line('.'), vim.fn.line('v') }) end, { desc = '[GS]: Stage Hunk' })
    keymap('v', '<leader>hr', function() gs.reset_hunk({ vim.fn.line('.'), vim.fn.line('v') }) end, { desc = '[GS]: Reset Hunk' })
    ...
    keymap('n', '<leader>hb', function() gs.blame_line({ full = true }) end, { desc = '[GS]: Blame Line' })
    ...
    keymap('n', '<leader>hD', function() gs.diffthis('~') end, { desc = '[GS]: Diff This' })
