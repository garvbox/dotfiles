#!/usr/bin/env bash
# Claude Code status line — carbonfox theme (matches Starship/tmux)
...
# carbonfox colours
dir_bg="\033[48;2;51;177;255m"   # #33b1ff
dir_fg="\033[38;2;22;22;22m"     # #161616
git_bg="\033[48;2;72;72;72m"     # #484848
git_fg="\033[38;2;51;177;255m"   # #33b1ff
...
printf "\033[38;2;51;177;255m${sep_open}${reset}"
printf "${dir_bg}${dir_fg} ${dir_short} ${reset}"
if [ -n "$git_branch" ]; then
  printf "\033[38;2;51;177;255m${git_bg}${sep_angle}${reset}"
  printf "${git_bg}${git_fg}${git_branch} ${reset}"
  printf "\033[38;2;72;72;72m${time_bg}${sep_angle}${reset}"
else
  printf "\033[38;2;51;177;255m${time_bg}${sep_angle}${reset}"
fi
